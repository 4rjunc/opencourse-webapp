...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='seatsopencourse',
            name='CSC',
            field=models.IntegerField(blank=True, null=True, verbose_name='Computer Science'),
        ),
        migrations.AddField(
            model_name='seatsopencourse',
            name='ECO',
        ...
        migrations.AddField(
            model_name='seatsopencourse',
            name='PED',
            field=models.IntegerField(blank=True, null=True, verbose_name='Physical Education'),
        ),
        migrations.AddField(
            model_name='seatsopencourse',
            name='PHY',
